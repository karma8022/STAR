			...
			<div className="" id="bgbg">
				<div className="flex justify-center items-center mt-16">
					<div className="collapse collapse-arrow bg-base-200 w-3/4">
						...
						<div className="collapse-content text-2xl background-with-opacity2">
							<p>
								You are requested to send a query related to one
								of the topics mentioned below. Keep the query
								relevant to the topic you have chosen.
							</p>
						</div>
					</div>
				</div>
				...
				>
					<div className="flex justify-start">
						{" "}
						<div className="text-4xl text-left p-4 text-white">
							{" "}
							Question{" "}
						</div>
					</div>
